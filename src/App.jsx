...
function App() {
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Contact Section */}
      <section id="contact" className="py-20 bg-gradient-to-br from-blue-600 via-blue-700 to-blue-800 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <div className="inline-block bg-blue-500/20 px-4 py-2 rounded-full text-sm mb-6">
              💬 Get In Touch
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            <div className="text-center">
              ...
              <p className="text-blue-100 mb-2">+220 301-5490</p>
              <p className="text-blue-100">+220 313-0176</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-blue-100">info@bedrockgambia.com</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-blue-100">The Gambia</p>
            </div>
          </div>
