...
function AboutPage() {
  return (
    <div className="bg-white text-foreground min-h-screen">
      ...
      {/* Main Content Wrapper with cream background */}
      <div className="bg-cream-50">
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
          
          {/* Our Story */}
          <section className="bg-white p-8 rounded-lg shadow-md mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-primary text-center mb-8">Our Story</h2>
            
            <div className="text-lg text-foreground space-y-6 max-w-4xl mx-auto">
              <p>
              ...
              <div className="grid md:grid-cols-2 gap-6 my-8">
                <div className="bg-muted rounded-lg h-60 flex items-center justify-center text-gray-500 italic">
            ...
            {/* Corrected button alignment for mobile */}
            <div className="mt-8 flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-4">
              <Link to="/#services" className="w-full sm:w-auto text-center bg-accent hover:bg-accent-hover text-white px-8 py-3 rounded-md font-semibold inline-block transition duration-300">
                View Our Services
              </Link>
              <Link to="/get-a-quote" className="w-full sm:w-auto text-center border-2 border-accent text-accent hover:bg-accent hover:text-white px-8 py-3 rounded-md font-semibold inline-block transition duration-300">
          ...
          {/* Core Values */}
          <section className="mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-primary text-center mb-8">Our Core Values</h2>
            
            <div className="bg-muted rounded-lg h-48 flex items-center justify-center text-gray-500 italic mb-8">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="bg-white p-6 rounded-lg shadow-lg border-t-4 border-primary">
                <h4 className="text-xl font-semibold text-primary mb-3">Reliability</h4>
                <p className="text-muted-foreground">
              ...
              <div className="bg-white p-6 rounded-lg shadow-lg border-t-4 border-primary">
                <h4 className="text-xl font-semibold text-primary mb-3">Environmental Responsibility</h4>
                <p className="text-muted-foreground">
      ...
      <section className="bg-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-primary mb-8">Why Choose Bedrock</h2>
          
          <div className="bg-muted rounded-lg h-96 flex items-center justify-center text-gray-500 italic mb-8 max-w-4xl mx-auto">
      ...
      <section className="bg-primary text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          {/* Corrected button alignment for mobile */}
          <div className="mt-8 flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-4">
            <Link to="/#contact" className="w-full sm:w-auto text-center bg-white text-primary hover:bg-gray-100 px-8 py-3 rounded-md font-semibold inline-block transition duration-300">
              Contact Us Today
            </Link>
            <Link to="/get-a-quote" className="w-full sm:w-auto text-center border-2 border-white text-white hover:bg-white hover:text-primary px-8 py-3 rounded-md font-semibold inline-block transition duration-300">
              Get Free Quote
            </Link>
          </div>
