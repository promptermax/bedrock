...
              <Link to="/#services" className="bg-accent hover:bg-accent-hover text-white px-8 py-3 rounded-md font-semibold mr-4 inline-block transition duration-300">
                View Our Services
              </Link>
              <Link to="/get-a-quote" className="border-2 border-accent text-accent hover:bg-accent hover:text-white px-8 py-3 rounded-md font-semibold inline-block transition duration-300">
...
          <div className="mt-8">
            <Link to="/#contact" className="bg-white text-primary hover:bg-gray-100 px-8 py-3 rounded-md font-semibold mr-4 inline-block transition duration-300">
              Contact Us Today
            </Link>
            <Link to="/get-a-quote" className="border-2 border-white text-white hover:bg-white hover:text-primary px-8 py-3 rounded-md font-semibold inline-block transition duration-300">
              Get Free Quote
            </Link>
          </div>
          
